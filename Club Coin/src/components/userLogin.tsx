    ...
    return (
      ...
      <div className="w-full max-w-xl bg-gray-800 rounded-xl shadow-xl overflow-hidden">
        <div className="text-center mb-6">
          <h2 className="p-4 text-2xl font-bold text-white-800">Welcome!</h2>
          {user.email && (
            <p className="text-gray-600 mt-2"> Email: {user.email.address}</p>
          )}
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-600 p-4 rounded-md m-4">
            ...
            {user.balance && (
              <p className="text-sm text-white-400 mb-1">
                <span className="font-medium">Wallet:</span> {getBalance(user.wallet.address)}
              </p>
            )}
          </div>
        </div>
